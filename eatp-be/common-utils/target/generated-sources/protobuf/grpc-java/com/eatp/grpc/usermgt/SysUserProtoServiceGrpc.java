...
public final class SysUserProtoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.eatp.grpc.usermgt.SysUserProtoRequest,
      com.eatp.grpc.usermgt.SysUserProtoResponse> getCreateSysUserProtoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createSysUserProto",
      requestType = com.eatp.grpc.usermgt.SysUserProtoRequest.class,
      responseType = com.eatp.grpc.usermgt.SysUserProtoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.eatp.grpc.usermgt.SysUserProtoRequest,
      com.eatp.grpc.usermgt.SysUserProtoResponse> getCreateSysUserProtoMethod() {
    io.grpc.MethodDescriptor<com.eatp.grpc.usermgt.SysUserProtoRequest, com.eatp.grpc.usermgt.SysUserProtoResponse> getCreateSysUserProtoMethod;
      ...
      synchronized (SysUserProtoServiceGrpc.class) {
        if ((getCreateSysUserProtoMethod = SysUserProtoServiceGrpc.getCreateSysUserProtoMethod) == null) {
          SysUserProtoServiceGrpc.getCreateSysUserProtoMethod = getCreateSysUserProtoMethod =
              io.grpc.MethodDescriptor.<com.eatp.grpc.usermgt.SysUserProtoRequest, com.eatp.grpc.usermgt.SysUserProtoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createSysUserProto"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.eatp.grpc.usermgt.SysUserProtoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.eatp.grpc.usermgt.SysUserProtoResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createSysUserProto(com.eatp.grpc.usermgt.SysUserProtoRequest request,
        io.grpc.stub.StreamObserver<com.eatp.grpc.usermgt.SysUserProtoResponse> responseObserver) {
  ...
  public static final class SysUserProtoServiceStub
    ...
    /**
     */
    public void createSysUserProto(com.eatp.grpc.usermgt.SysUserProtoRequest request,
        io.grpc.stub.StreamObserver<com.eatp.grpc.usermgt.SysUserProtoResponse> responseObserver) {
  ...
  public static final class SysUserProtoServiceBlockingStub
    ...
    /**
     */
    public com.eatp.grpc.usermgt.SysUserProtoResponse createSysUserProto(com.eatp.grpc.usermgt.SysUserProtoRequest request) {
  ...
  public static final class SysUserProtoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.eatp.grpc.usermgt.SysUserProtoResponse> createSysUserProto(
        com.eatp.grpc.usermgt.SysUserProtoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_SYS_USER_PROTO:
          serviceImpl.createSysUserProto((com.eatp.grpc.usermgt.SysUserProtoRequest) request,
              (io.grpc.stub.StreamObserver<com.eatp.grpc.usermgt.SysUserProtoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.eatp.grpc.usermgt.SysUserProtoRequest,
              com.eatp.grpc.usermgt.SysUserProtoResponse>(
  ...
  private static abstract class SysUserProtoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.eatp.grpc.usermgt.SysUserProto.getDescriptor();
    }
